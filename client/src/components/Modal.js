...
const Modal = ({mode, setMode, fetchData, currentPost}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (createMode) {
                const response = await axios.post("http:/loclahost:8000/create", {
                    data
                })
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="multi-input">
                        <div className="image-preview">
                            {form.photo && <img src={form.photo} alt="uploaded preview"/>}
                        </div>
                        <div className="main-inputs">
                            <div className="input-container">
                                <label htmlFor="photo">PHOTO</label>
                                <input id="photo" name="photo" placeholder="Photo URL goes here" required
                            ...
                            <div className="input-container">
                                ...
                                <input id="website" name="website" placeholder="Website goes here" required
                    ...
                    <div className="multi-input">
                        <div className="input-container">
                            ...
                            <input id="line" name="line" placeholder="First Line of Address" required
                             value={form.line} onChange={handleChange} />
                        </div>
                        <div className="input-container">
                            <label htmlFor="country">COUNTRY</label>
                            <input id="country" name="country" placeholder="The Country" required
                            value={form.country} onChange={handleChange} />
                        </div>
                        <div className="input-container">
                            <label htmlFor="town">TOWN/CITY</label>
                            <input id="town" name="town" placeholder="Town (or City)" required
                    ...
                    <div className="multi-input">
                        <div className="input-container">
                            ...
                            <input id="nature-checkbox" type="checkbox" name="nature"
                            checked={form.nature} onChange={handleChange} />
                        </div>
                        <div className="input-container">
                            <label htmlFor="nature">Mountains</label>
                            <input id="mountains-checkbox" type="checkbox" name="mountains"
                            checked={form.mountains} onChange={handleChange} />
                        </div>
                        <div className="input-container">
                            <label htmlFor="nature">Hiking</label>
                            <input id="hiking-checkbox" type="checkbox" name="hiking"
                            checked={form.hiking} onChange={handleChange} />
                        </div>
                        <div className="input-container">
                            <label htmlFor="nature">Beach</label>
                            <input id="beach-checkbox" type="checkbox" name="beach"
                            checked={form.beach} onChange={handleChange} />
                        </div>
                        <div className="input-container">
                            <label htmlFor="nature">Sun</label>
                            <input id="sun-checkbox" type="checkbox" name="sun"
                            checked={form.sun} onChange={handleChange} />
                        </div>
